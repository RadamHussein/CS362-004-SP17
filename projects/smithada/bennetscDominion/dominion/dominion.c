...
void playSeaHag(struct gameState *state, int currentPlayer) {
	int i;
	for (i = 0; i < state->numPlayers; i++){
	   if (i == currentPlayer){
...
void playAdventurer (struct gameState *state, int temphand[MAX_HAND], int currentPlayer) {

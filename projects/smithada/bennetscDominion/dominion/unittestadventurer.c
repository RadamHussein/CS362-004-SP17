...
int main(){
	...
	printf("Player 1's hand after call to adventurer: \n");
	printf("handCount: %d\n", G.handCount[1]);
	displayHand(1, &G, G.handCount[1]);

	printf("Player 1's deck after call to adventurer: \n");
	printf("deckCount: %d\n", G.deckCount[1]);
	displayDeck(1, &G, G.deckCount[1]);

	printf("Player 1's discard count after call to adventurer: %d\n", G.discardCount[1]);
	//displayDiscard(1, &G, G.discardCount);
